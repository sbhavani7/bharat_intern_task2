  ...
  <div id="foreman_portfolio_report" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
            <div class="modal-dialog"> 
               <div class="modal-content modal-md">  
                  ...
                  <div class="modal-header"> 
                     <h4 class="modal-title" id='head'>
                     <i class=""></i> Manager Portfolio Records
                     </h4> 
                     <div id="retCode1"></div>
                  </div> 
    ...
    <div class="form-horizontal">
      ...
      <div class="form-group" id="form-login">
          ...
          <div class="col-sm-8">
            ...
            <option selected="" disabled=""></option>
           <?php
            $pp = mysqli_query($conn,"SELECT *,CONCAT(lastname,', ',firstname,' ',midname) as name FROM employee natural join position where position = 'Manager' ");
            while($pp_row=mysqli_fetch_assoc($pp)){
            ?>
